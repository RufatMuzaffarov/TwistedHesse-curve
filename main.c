...
int main()
{
    ...
    printf("Тест 1: Лежит ли точка S=(2:3:4) на кривой\n");
...
//    print_in_affine(&P2);
    ...
    printf("Тест 2: Проверка нахождения [k]P на кривой\n");
    BIGNUM* k = BN_new();
    BN_dec2bn(&k, "184252");
    printf("k = %s\n", BN_bn2dec(k));
...
//    print_in_affine(&qP);
    ...
    printf("Тест 5: Проверка равенства [q+1]P = P и [q-1] = -P\n\n");
    BIGNUM* num = BN_new();
